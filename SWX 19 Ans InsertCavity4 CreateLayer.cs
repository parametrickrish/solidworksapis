...
namespace WindowsFormsApp5
{
    public partial class Form1 : Form
    {
        ...
        private void btnExistingDrawing_Click(object sender, EventArgs e)
        {
            ...
            SldWorks.DrawingDoc swDrwDoc = null;
            swDrwDoc = (DrawingDoc)swModel;

            if (swDrwDoc == null)
            {
                swApp.SendMsgToUser2("Please open a drawing", 2, 2);
                return;
            }

           

            if (chkCreateLayer.Checked)
            {
                swModel.ClearSelection2(true);
                bool bootstat;
                bootstat = swDrwDoc.CreateLayer2("MyRedLayer", "Red", 0, (int)swLineStyles_e.swLineCONTINUOUS, (int)swLineWeights_e.swLW_NORMAL, true, true);
            }
